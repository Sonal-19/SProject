...
const SearchProduct = () => {
  ...
  // Move the definition of 'productsPerPage' to the top
  const productsPerPage = 8;

  const location = useLocation();
  console.log("Location in SearchProduct:", location);

  // Wrap the initialization of 'products' in useMemo
  ...
  useEffect(() => {
    // Recalculate totalPages whenever the products array changes
    const newTotalPages = Math.ceil(products.length / productsPerPage);
    setTotalPages(newTotalPages || 1); // Ensure at least 1 page is displayed
